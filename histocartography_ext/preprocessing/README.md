...
stages:
  - module1:
      class: class_name1 # (str) class to import from histocartography_ext.preprocessing.module1
      inputs:
      - input1
      outputs:
      - output1
      params:
        # Keyword arguments to histocartography_ext.preprocessing.module1.class_name1.__init__
  - module2:
      class: class_name2 # (str) class to import from histocartography_ext.preprocessing.module2
      inputs:
      - input2
      - output1
      outputs:
